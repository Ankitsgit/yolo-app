...
// import { getTodayMeals, logMeal } from '../services/api'

// const MealLogger = ({ userId, onUpdate }) => {
  
//   const [meals, setMeals] = useState([])
//   const [totals, setTotals] = useState({
//     totalCalories: 0, remaining: 1800, calorieTarget: 1800
//   })
//   // 🧠 LEARN: showForm toggles the add-meal form visibility
...
// //         // 🧠 LEARN: Number() converts text "520" to number 520
...
//     // Show warning if AI flagged overages
//     // 🧠 LEARN: data.warnings is an array — join into one string
...
//   } catch (err) {
//     // err.message contains the hard block message from backend
...
//   // Color changes based on how close to calorie limit
//   // 🧠 LEARN: ternary operator — condition ? valueIfTrue : valueIfFalse
//   const remainingColor = totals.remaining < 200 ? '#E24B4A'
//     : totals.remaining < 500 ? '#EF9F27'
//     : '#1D9E75'
...
//           </div>
//           <div style={{ fontSize: 11, color: '#999' }}>remaining</div>
//         </div>
//       </div>
...
//           <div style={{
//             height: '100%',
//             // 🧠 LEARN: Math.min prevents bar exceeding 100%
...
//           <span style={{ fontSize: 12, color: '#666' }}>{totals.totalCalories} consumed</span>
//           <span style={{ fontSize: 12, color: '#666' }}>target: {totals.calorieTarget}</span>
//         </div>
//       </div>

//       {/* Meal list */}
//       {meals.length === 0 ? (
//         <p style={{ fontSize: 13, color: '#999', padding: '8px 0' }}>No meals logged yet today.</p>
//       ) : (
//         meals.map(meal => (
...
//           }}>
//             <div>
//               <div style={{ fontSize: 13, fontWeight: 500 }}>{meal.mealName}</div>
//               <div style={{ fontSize: 12, color: '#999' }}>{meal.foodDesc}</div>
//             </div>
//             <div style={{ textAlign: 'right', flexShrink: 0 }}>
//               <div style={{ fontSize: 13, fontWeight: 500 }}>{meal.calories} kcal</div>
//               {meal.protein > 0 && (
//                 <div style={{ fontSize: 11, color: '#999' }}>{meal.protein}g protein</div>
//               )}
//             </div>
//           </div>
//         ))
...
//       {/* Add meal form */}
//       {showForm ? (
//         <form onSubmit={handleAddMeal} style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
//           <select
...
//             />
//             <input
//               type="number" placeholder="Protein (g) optional"
